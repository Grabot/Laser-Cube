package com.games.Android.Laser_Cube.Level9;
...
{   
        ...
        public Simulation( Level9 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_red_1 = new Cube();
        		cube_red_1.position.set( 50, -40, 0 );
        		cubes.add(cube_red_1);
        		
        		mirror_1 = new Mirror();
        		mirror_1.position.set( 60, -30, 0 );
        		mirrors.add(mirror_1);
        		mirror_2 = new Mirror();
        		mirror_2.position.set( 20, -30, 0 );
        		...
        		radiation_tile_2 = new Radiation_Tile( new Vector( 60, 0, 0));
        		...
        		radiation_tile_5 = new Radiation_Tile( new Vector( 20, 0, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		radiation_tile_6 = new Radiation_Tile( new Vector( 0, 20, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( 0, -20, 0));
        		...
        		radiation_tile_11 = new Radiation_Tile( new Vector( -80, 40, 0));
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( 50, -40, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 60, -30, 0 ));
        		mirrors.get(2).position.set( new Vector( 20, -30, 0 ));
