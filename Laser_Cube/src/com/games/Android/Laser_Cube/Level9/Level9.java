...
public class Level9 implements Screen
{
	...
	public Level9( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_9_Game", 2 );
			...
			if( prefs.getInteger("Level_4_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_4_Game", 1 );
			}
