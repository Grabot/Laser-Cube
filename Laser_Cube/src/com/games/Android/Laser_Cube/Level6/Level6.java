...
public class Level6 implements Screen
{
	...
	public Level6( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_6_Game", 2 );
			...
			if( prefs.getInteger("Level_1_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_1_Game", 1 );
			}
