package com.games.Android.Laser_Cube.Level6;
...
{   
        ...
        public Simulation( Level6 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		radiation_tile_2 = new Radiation_Tile( new Vector( -50, 0, 0));
        		radiation_tiles.add( radiation_tile_2 );
        		radiation_tile_3 = new Radiation_Tile( new Vector( 0, -10, 0));
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		...
        		mirrors.get(2).position.set( new Vector( 30, 30, 0 ));
