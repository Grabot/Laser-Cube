...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(8), rotate_mirrors[8], false, triple_refraction );
        ...
        init.Build_Colour_Changer( gl, simulation.colour_changers.get(1), rotate_colour_changers[1], yellow, false );
