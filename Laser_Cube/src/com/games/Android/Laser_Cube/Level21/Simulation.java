package com.games.Android.Laser_Cube.Level21;
...
{   
        ...
        public Simulation( Level21 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		radiation_tile_3 = new Radiation_Tile( new Vector( -10, 40, 0));
        		radiation_tiles.add( radiation_tile_3 );
        		radiation_tile_4 = new Radiation_Tile( new Vector( -10, -20, 0));
        		...
        		//red
        		radiation_tile_6 = new Radiation_Tile( new Vector( 70, -20, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( -20, 30, 0));
        		...
        		//yellow
        		radiation_tile_9 = new Radiation_Tile( new Vector( 70, 10, 0));
        		...
        		radiation_tile_11 = new Radiation_Tile( new Vector( 0, 10, 0));
        		...
        		mirror_shape[9] = forward_refraction;
        		mirror_shape[10] = forward_refraction;
                ...
                colour_changer_1.position.set( 10, 30, 0 );
                ...
                block_1 = new Block( new Vector( 80, -10, 0 ));
                blocks.add( block_1 );
                block_2 = new Block( new Vector( 70, -10, 0 ));
                blocks.add( block_2 );
                block_3 = new Block( new Vector( 50, -10, 0 ));
                blocks.add( block_3 );
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		...
        		cubes.get(2).position.set( new Vector( 40, 0, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 30, -20, 0 ));
        		mirrors.get(2).position.set( new Vector( -30, -20, 0 ));
        		mirrors.get(3).position.set( new Vector( -20, 10, 0 ));
        		mirrors.get(4).position.set( new Vector( 20, 30, 0 ));
        		mirrors.get(5).position.set( new Vector( 70, 40, 0 ));
        		mirrors.get(6).position.set( new Vector( 0, 0, 0 ));
        		mirrors.get(7).position.set( new Vector( -80, 30, 0 ));
        		mirrors.get(8).position.set( new Vector( 70, -30, 0 ));
        		
        		colour_changers.get(1).position.set( new Vector( 10, 30, 0 ));
        	}
        }
