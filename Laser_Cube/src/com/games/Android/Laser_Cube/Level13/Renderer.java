...
public class Renderer
{
	...
	public Renderer( Init_Renderer init )
	{
		...
		this.init = init;
        Gdx.app.log( Renderer.LOG, "Level 9" );
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        //3 keer single, 4 keer forward, 1 keer double, 1 keer triple: 3 + 4 + 1 + 1 = 9
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(4), rotate_mirrors[4], true, forward_refraction );
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(8), rotate_mirrors[8], true, double_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(9), rotate_mirrors[9], true, triple_refraction );
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(16), rotate_mirrors[16], false, double_refraction );
