...
public class Level13 implements Screen
{
	...
	public Level13( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_13_Game", 2 );
			if( prefs.getInteger("Level_18_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_18_Game", 1 );
			}
