package com.games.Android.Laser_Cube.Level13;
...
{   
	    ...
	    private int foward_refraction = 24;
        ...
        public Simulation( Level13 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_yellow.position.set( 40, -10, 0 );
        		cubes.add(cube_yellow);

        		radiation_tile_1 = new Radiation_Tile( new Vector( 60, 40, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 60, -40, 0));
        		radiation_tiles.add( radiation_tile_2 );
        		radiation_tile_3 = new Radiation_Tile( new Vector( 30, 0, 0));
        		radiation_tiles.add( radiation_tile_3 );
        		radiation_tile_4 = new Radiation_Tile( new Vector( 0, 0, 0));
        		radiation_tiles.add( radiation_tile_4 );
        		radiation_tile_5 = new Radiation_Tile( new Vector( -70, -20, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		radiation_tile_6 = new Radiation_Tile( new Vector( -80, 40, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( -80, -10, 0));
        		radiation_tiles.add( radiation_tile_7 );
        		radiation_tile_8 = new Radiation_Tile( new Vector( 10, -30, 0));
        		radiation_tiles.add( radiation_tile_8 );
        		radiation_tile_9 = new Radiation_Tile( new Vector( 60, 20, 0));
        		radiation_tiles.add( radiation_tile_9 );
        		radiation_tile_10 = new Radiation_Tile( new Vector( -20, -40, 0));
        		radiation_tiles.add( radiation_tile_10 );
        		radiation_tile_11 = new Radiation_Tile( new Vector( 80, 0, 0));
        		radiation_tiles.add( radiation_tile_11 );
        		
        		
        		mirror_1 = new Mirror();
        		mirror_1.position.set( 60, 0, 0 );
        		mirrors.add(mirror_1);
        		mirror_2 = new Mirror();
        		mirror_2.position.set( 60, -10, 0 );
        		mirrors.add(mirror_2);
        		mirror_3 = new Mirror();
        		mirror_3.position.set( 20, 0, 0 );
        		mirrors.add(mirror_3);
        		mirror_4 = new Mirror();
        		mirror_4.position.set( 0, -20, 0 );
        		mirrors.add(mirror_4);
        		mirror_5 = new Mirror();
        		mirror_5.position.set( 20, 40, 0 );
        		mirrors.add(mirror_5);
        		mirror_6 = new Mirror();
        		mirror_6.position.set( 20, -20, 0 );
        		mirrors.add(mirror_6);
        		mirror_7 = new Mirror();
        		mirror_7.position.set( 0, 40, 0 );
        		mirrors.add(mirror_7);
        		mirror_8 = new Mirror();
        		mirror_8.position.set( -20, -20, 0 );
        		mirrors.add(mirror_8);
        		mirror_9 = new Mirror();
        		mirror_9.position.set( -50, 20, 0 );
        		mirrors.add(mirror_9);
        		mirror_10 = new Mirror();
        		mirror_10.position.set( 40, 20, 0 );
        		mirrors.add(mirror_10);
        		mirror_11 = new Mirror();
        		mirror_11.position.set( 40, -30, 0 );
        		mirrors.add(mirror_11);
        		mirror_12 = new Mirror();
        		mirror_12.position.set( 30, 20, 0 );
        		mirrors.add(mirror_12);
        		mirror_13 = new Mirror();
        		mirror_13.position.set( 10, 30, 0 );
        		mirrors.add(mirror_13);
        		mirror_14 = new Mirror();
        		mirror_14.position.set( -30, -30, 0 );
        		mirrors.add(mirror_14);
        		mirror_15 = new Mirror();
        		mirror_15.position.set( -30, 40, 0 );
        		mirrors.add(mirror_15);
        		mirror_16 = new Mirror();
        		mirror_16.position.set( -20, 0, 0 );
        		mirrors.add(mirror_16);
        		mirror_17 = new Mirror();
        		mirror_17.position.set( -50, 10, 0 );
        		mirrors.add(mirror_17);
        		mirror_18 = new Mirror();
        		mirror_18.position.set( -60, 30, 0 );
        		mirrors.add(mirror_18);
        
        		block_1 = new Block( new Vector ( -70, -10, 0 ) );
                blocks.add(block_1);
                block_2 = new Block( new Vector ( -80, -20, 0 ) );
                blocks.add(block_2);
        		
        		mirror_shape[1] = foward_refraction;
        		mirror_shape[2] = foward_refraction;
        		mirror_shape[3] = foward_refraction;
        		mirror_shape[4] = foward_refraction;
        		mirror_shape[5] = single_refraction;
        		mirror_shape[6] = single_refraction;
        		mirror_shape[7] = single_refraction;
        		mirror_shape[8] = double_refraction;
        		mirror_shape[9] = triple_refraction;
        		...
        		mirror_shape[16] = double_refraction;
        		mirror_shape[17] = double_refraction;
                ...
                radiation_tiles_colour[1] = geel;
                radiation_tiles_colour[2] = geel;
                radiation_tiles_colour[3] = geel;
                radiation_tiles_colour[4] = geel;
                radiation_tiles_colour[5] = geel;
                radiation_tiles_colour[6] = geel;
                radiation_tiles_colour[7] = geel;
        	    ...
        	    rotate_mirrors[4] = 90;
        	    rotate_mirrors[6] = 90;
        	    rotate_mirrors[7] = 270;
        	    rotate_mirrors[8] = 270;
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( 40, -10, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 60, 0, 0 ));
        		mirrors.get(2).position.set( new Vector( 60, -10, 0 ));
        		mirrors.get(3).position.set( new Vector( 20, 0, 0 ));
        		mirrors.get(4).position.set( new Vector( 0, -20, 0 ));
        		mirrors.get(5).position.set( new Vector( 20, 40, 0 ));
        		mirrors.get(6).position.set( new Vector( 20, -20, 0 ));
        		mirrors.get(7).position.set( new Vector( 0, 40, 0 ));
        		mirrors.get(8).position.set( new Vector( -20, -20, 0 ));
        		mirrors.get(9).position.set( new Vector( -50, 20, 0 ));
        		mirrors.get(10).position.set( new Vector( 40, 20, 0 ));
        		mirrors.get(11).position.set( new Vector( 40, -30, 0 ));
        		mirrors.get(12).position.set( new Vector( 30, 20, 0 ));
        		mirrors.get(13).position.set( new Vector( 10, 30, 0 ));
        		mirrors.get(14).position.set( new Vector( -30, -30, 0 ));
        		mirrors.get(15).position.set( new Vector( -30, 40, 0 ));
        		mirrors.get(16).position.set( new Vector( -20, 0, 0 ));
        		mirrors.get(17).position.set( new Vector( -50, 10, 0 ));
        		mirrors.get(18).position.set( new Vector( -60, 30, 0 ));
