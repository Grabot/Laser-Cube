package com.games.Android.Laser_Cube.Level37;
...
{   
        ...
        public Simulation( Level37 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_yellow.position.set( 0, -40, 0 );
        		cubes.add(cube_yellow);
        		cube_red = new Cube();
        		cube_red.position.set( -10, -40, 0 );
        		cubes.add(cube_red);
        		...
        		radiation_tile_6 = new Radiation_Tile( new Vector( 0, 30, 0));
        		...
        		radiation_tile_8 = new Radiation_Tile( new Vector( -40, -20, 0));
        		...
        		radiation_tile_11 = new Radiation_Tile( new Vector( -50, 20, 0));
