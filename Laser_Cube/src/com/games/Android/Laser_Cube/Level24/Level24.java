...
public class Level24 implements Screen
{
	...
	public Level24( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_24_Game", 2 );
			if( prefs.getInteger("Level_25_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_25_Game", 1 );
			}
			if( prefs.getInteger("Level_23_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_23_Game", 1 );
			}
