package com.games.Android.Laser_Cube.Level24;
...
{   
        ...
        public Simulation( Level24 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green_1.position.set( -60, -20, 0 );
        		cubes.add(cube_green_1);
        		cube_green_2 = new Cube();
        		cube_green_2.position.set( -20, 20, 0 );
        		cubes.add(cube_green_2);
        		
        		//green
        		radiation_tile_1 = new Radiation_Tile( new Vector( 70, -40, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 70, -30, 0));
        		radiation_tiles.add( radiation_tile_2 );
        		radiation_tile_3 = new Radiation_Tile( new Vector( 30, 30, 0));
        		...
        		radiation_tile_5 = new Radiation_Tile( new Vector( -50, 30, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		
        		//red
        		radiation_tile_6 = new Radiation_Tile( new Vector( 70, -10, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( 70, 30, 0));
        		...
        		radiation_tile_9 = new Radiation_Tile( new Vector( -50, -10, 0));
        		radiation_tiles.add( radiation_tile_9 );
        		
        		//yellow
        		radiation_tile_10 = new Radiation_Tile( new Vector( -30, -20, 0));
        		...
        		radiation_tile_12 = new Radiation_Tile( new Vector( -60, -40, 0));
        		...
        		mirror_2 = new Mirror();
        		mirror_2.position.set( 60, 20, 0 );
        		mirrors.add(mirror_2);
        		mirror_3 = new Mirror();
        		mirror_3.position.set( -30, -30, 0 );
        		mirrors.add(mirror_3);
        		mirror_4 = new Mirror();
        		mirror_4.position.set( 0, 30, 0 );
        		mirrors.add(mirror_4);
        		mirror_5 = new Mirror();
        		mirror_5.position.set( 30, -30, 0 );
        		mirrors.add(mirror_5);
        		mirror_6 = new Mirror();
        		mirror_6.position.set( -50, -40, 0 );
        		mirrors.add(mirror_6);
        		
        		mirror_7 = new Mirror();
        		mirror_7.position.set( 50, 10, 0 );
        		mirrors.add(mirror_7);
        		mirror_8 = new Mirror();
        		mirror_8.position.set( 30, 10, 0 );
        		mirrors.add(mirror_8);
        		mirror_9 = new Mirror();
        		mirror_9.position.set( -10, 10, 0 );
        		mirrors.add(mirror_9);
        		mirror_10 = new Mirror();
        		mirror_10.position.set( -30, 10, 0 );
                ...
                colour_changer_1.position.set( 40, 10, 0 );
                colour_changers.add(colour_changer_1);
                colour_changer_2 = new Colour_Changer();
                colour_changer_2.position.set( -20, 10, 0 );
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( -60, -20, 0 ));
        		cubes.get(2).position.set( new Vector( -20, 20, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( -70, 20, 0 ));
        		mirrors.get(2).position.set( new Vector( 60, 20, 0 ));
        		mirrors.get(3).position.set( new Vector( -30, -30, 0 ));
        		mirrors.get(4).position.set( new Vector( 0, 30, 0 ));
        		mirrors.get(5).position.set( new Vector( 30, -30, 0 ));
        		mirrors.get(6).position.set( new Vector( -50, -40, 0 ));
        	}
        }
