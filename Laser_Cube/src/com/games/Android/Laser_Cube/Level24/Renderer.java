...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Cube( gl, simulation.cubes.get(2), rotate_cubes[2], green, false );
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(7), rotate_mirrors[7], true, double_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(8), rotate_mirrors[8], true, double_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(9), rotate_mirrors[9], true, double_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(10), rotate_mirrors[10], true, double_refraction );
         
        init.Build_Colour_Changer( gl, simulation.colour_changers.get(1), rotate_colour_changers[1], red, true );
