...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(11), radiation_tile_touch[11], yellow );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(12), radiation_tile_touch[12], yellow );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(13), radiation_tile_touch[13], yellow );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(14), radiation_tile_touch[14], yellow );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(15), radiation_tile_touch[15], red );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(16), radiation_tile_touch[16], red );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(17), radiation_tile_touch[17], red );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(18), radiation_tile_touch[18], red );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(19), radiation_tile_touch[19], red );

        init.Build_Cube( gl, simulation.cubes.get(1), rotate_cubes[1], green, true );
        init.Build_Cube( gl, simulation.cubes.get(2), rotate_cubes[2], yellow, true );
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(3), rotate_mirrors[3], false, double_refraction );
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(6), rotate_mirrors[6], false, double_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(7), rotate_mirrors[7], false, double_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(8), rotate_mirrors[8], false, double_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(9), rotate_mirrors[9], false, triple_refraction );
