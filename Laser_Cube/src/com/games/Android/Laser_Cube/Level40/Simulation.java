package com.games.Android.Laser_Cube.Level40;
...
{   
        ...
        public Radiation_Tile radiation_tile_17;
        public Radiation_Tile radiation_tile_18;
        public Radiation_Tile radiation_tile_19;
        ...
        public Simulation( Level40 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		radiation_tile_6 = new Radiation_Tile( new Vector( -50, 0, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( -50, 20, 0));
        		radiation_tiles.add( radiation_tile_7 );
        		radiation_tile_8 = new Radiation_Tile( new Vector( -60, 40, 0));
        		radiation_tiles.add( radiation_tile_8 );
        		radiation_tile_9 = new Radiation_Tile( new Vector( -80, -10, 0));
        		radiation_tiles.add( radiation_tile_9 );
        		
        		//yellow
        		radiation_tile_10 = new Radiation_Tile( new Vector( 80, -10, 0));
        		radiation_tiles.add( radiation_tile_10 );
        		radiation_tile_11 = new Radiation_Tile( new Vector( 60, 30, 0));
        		radiation_tiles.add( radiation_tile_11 );
        		radiation_tile_12 = new Radiation_Tile( new Vector( -10, 30, 0));
        		radiation_tiles.add( radiation_tile_12 );
        		radiation_tile_13 = new Radiation_Tile( new Vector( -30, -20, 0));
        		radiation_tiles.add( radiation_tile_13 );
        		radiation_tile_14 = new Radiation_Tile( new Vector( -80, 30, 0));
        		radiation_tiles.add( radiation_tile_14 );
        		
        		//red
        		radiation_tile_15 = new Radiation_Tile( new Vector( 70, -20, 0));
        		radiation_tiles.add( radiation_tile_15 );
        		radiation_tile_16 = new Radiation_Tile( new Vector( 70, 40, 0));
        		radiation_tiles.add( radiation_tile_16 );
        		radiation_tile_17 = new Radiation_Tile( new Vector( 30, 0, 0));
        		radiation_tiles.add( radiation_tile_17 );
        		radiation_tile_18 = new Radiation_Tile( new Vector( 10, -20, 0));
        		radiation_tiles.add( radiation_tile_18 );
        		radiation_tile_19 = new Radiation_Tile( new Vector( 10, 40, 0));
        		radiation_tiles.add( radiation_tile_19 );
        		
        		mirror_1 = new Mirror();
        		mirror_1.position.set( 0, -40, 0 );
        		...
        		mirror_9 = new Mirror();
        		mirror_9.position.set( -40, 40, 0 );
        		mirrors.add(mirror_9);
        		
        		colour_changer_1 = new Colour_Changer();
                colour_changer_1.position.set( 10, 20, 0 );
                ...
                radiation_tiles_colour[15] = rood;
                radiation_tiles_colour[16] = rood;
                radiation_tiles_colour[17] = rood;
                radiation_tiles_colour[18] = rood;
                radiation_tiles_colour[19] = rood;
