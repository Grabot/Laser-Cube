package com.games.Android.Laser_Cube.Level28;
...
{   
        ...
        public Simulation( Level28 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green = new Cube();
        		cube_green.position.set( 60, 0, 0 );
        		cubes.add(cube_green);
        		
        		//green
        		radiation_tile_1 = new Radiation_Tile( new Vector( 60, 10, 0));
        		...
        		radiation_tile_3 = new Radiation_Tile( new Vector( 30, 10, 0));
        		radiation_tiles.add( radiation_tile_3 );
        		radiation_tile_4 = new Radiation_Tile( new Vector( -30, 40, 0));
        		radiation_tiles.add( radiation_tile_4 );
        		radiation_tile_5 = new Radiation_Tile( new Vector( -80, 10, 0));
        		...
        		radiation_tile_7 = new Radiation_Tile( new Vector( 20, -20, 0));
        		...
        		//yellow
        		radiation_tile_9 = new Radiation_Tile( new Vector( 70, -40, 0));
        		radiation_tiles.add( radiation_tile_9 );
        		radiation_tile_10 = new Radiation_Tile( new Vector( 10, 0, 0));
        		radiation_tiles.add( radiation_tile_10 );
        		radiation_tile_11 = new Radiation_Tile( new Vector( 10, 40, 0));
        		radiation_tiles.add( radiation_tile_11 );
        		radiation_tile_12 = new Radiation_Tile( new Vector( -10, -40, 0));
        		radiation_tiles.add( radiation_tile_12 );
        		radiation_tile_13 = new Radiation_Tile( new Vector( -50, -40, 0));
        		radiation_tiles.add( radiation_tile_13 );

        		mirror_1 = new Mirror();
        		mirror_1.position.set( 0, 20, 0 );
        		mirrors.add(mirror_1);
        		mirror_2 = new Mirror();
        		mirror_2.position.set( -40, 0, 0 );
        		mirrors.add(mirror_2);
        		mirror_3 = new Mirror();
        		mirror_3.position.set( -60, 30, 0 );
        		mirrors.add(mirror_3);
        		mirror_4 = new Mirror();
        		mirror_4.position.set( 30, -20, 0 );
        		mirrors.add(mirror_4);
        		mirror_5 = new Mirror();
        		mirror_5.position.set( 80, 20, 0 );
        		mirrors.add(mirror_5);
        		
        		mirror_shape[1] = double_refraction;
        		mirror_shape[2] = double_refraction;
        		mirror_shape[3] = double_refraction;
        		mirror_shape[4] = triple_refraction;
        		mirror_shape[5] = triple_refraction;
                ...
                colour_changer_1.position.set( 20, -40, 0 );
                colour_changers.add(colour_changer_1);
                colour_changer_2 = new Colour_Changer();
                colour_changer_2.position.set( -80, 30, 0 );
        	    ...
        	    rotate_mirrors[2] = 90;
        	    rotate_mirrors[3] = 180;
        	    rotate_mirrors[5] = 270;
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{   
        		cubes.get(1).position.set( new Vector( 60, 0, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 0, 20, 0 ));
        		mirrors.get(2).position.set( new Vector( -40, 0, 0 ));
        		mirrors.get(3).position.set( new Vector( -60, 30, 0 ));
        		mirrors.get(4).position.set( new Vector( 30, -20, 0 ));
        		mirrors.get(5).position.set( new Vector( 80, 20, 0 ));
        		
        		colour_changers.get(1).position.set( new Vector( 20, -40, 0 ));
        		colour_changers.get(2).position.set( new Vector( -80, 30, 0 ));
        	}
        }
