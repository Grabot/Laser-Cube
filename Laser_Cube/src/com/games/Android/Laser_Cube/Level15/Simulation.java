...
{   
        ...
        public Simulation( Level15 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		radiation_tile_3 = new Radiation_Tile( new Vector( 20, 0, 0));
        		...
        		radiation_tile_6 = new Radiation_Tile( new Vector( -20, 40, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( -20, 0, 0));
        		radiation_tiles.add( radiation_tile_7 );
        		radiation_tile_8 = new Radiation_Tile( new Vector( -30, -30, 0));
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		...
        		mirrors.get(3).position.set( new Vector( 30, 20, 0 ));
        		mirrors.get(4).position.set( new Vector( 50, -30, 0 ));
        		mirrors.get(5).position.set( new Vector( 0, 0, 0 ));
        		mirrors.get(6).position.set( new Vector( -20, 20, 0 ));
        		mirrors.get(7).position.set( new Vector( 30, -10, 0 ));
