...
{   
        ...
        public Simulation( Level31 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		radiation_tile_2 = new Radiation_Tile( new Vector( 20, 20, 0));
        		...
        		radiation_tile_4 = new Radiation_Tile( new Vector( -70, 20, 0));
        		...
        		radiation_tile_6 = new Radiation_Tile( new Vector( 0, 0, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( -10, -40, 0));
        		radiation_tiles.add( radiation_tile_7 );
        		radiation_tile_8 = new Radiation_Tile( new Vector( -10, 0, 0));
        		radiation_tiles.add( radiation_tile_8 );
        		
        		//green
        		radiation_tile_9 = new Radiation_Tile( new Vector( 40, -20, 0));
        		radiation_tiles.add( radiation_tile_9 );
        		radiation_tile_10 = new Radiation_Tile( new Vector( -50, -20, 0));
        		radiation_tiles.add( radiation_tile_10 );

        		mirror_1 = new Mirror();
        		mirror_1.position.set( -80, -20, 0 );
                ...
                colour_changer_2.position.set( 60, 30, 0 );
                colour_changers.add(colour_changer_2);
                colour_changer_3 = new Colour_Changer();
                colour_changer_3.position.set( -60, -20, 0 );
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		...
        		cubes.get(2).position.set( new Vector( -60, 0, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( -80, -20, 0 ));
        		mirrors.get(2).position.set( new Vector( 50, -30, 0 ));
        		mirrors.get(3).position.set( new Vector( 0, -20, 0 ));
        		mirrors.get(4).position.set( new Vector( 20, -40, 0 ));
        		
        		colour_changers.get(1).position.set( new Vector( 10, 30, 0 ));
        		colour_changers.get(2).position.set( new Vector( 60, 30, 0 ));
        		colour_changers.get(3).position.set( new Vector( -60, -20, 0 ));
        	}
        }
