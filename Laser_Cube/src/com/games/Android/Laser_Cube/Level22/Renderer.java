...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(14), rotate_mirrors[14], true, forward_refraction );
        
        init.Build_Colour_Changer( gl, simulation.colour_changers.get(1), rotate_colour_changers[1], yellow, true );
        init.Build_Colour_Changer( gl, simulation.colour_changers.get(2), rotate_colour_changers[2], yellow, true );
