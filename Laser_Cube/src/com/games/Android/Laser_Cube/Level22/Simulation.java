package com.games.Android.Laser_Cube.Level22;
...
{   
        ...
        public Simulation( Level22 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		radiation_tile_5 = new Radiation_Tile( new Vector( -30, -10, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		
        		//green
        		radiation_tile_6 = new Radiation_Tile( new Vector( 10, -20, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( -20, -40, 0));
        		radiation_tiles.add( radiation_tile_7 );
        		
        		//red
        		radiation_tile_8 = new Radiation_Tile( new Vector( -50, 20, 0));
        		...
        		mirror_shape[12] = forward_refraction;
        		mirror_shape[13] = forward_refraction;
        		mirror_shape[14] = forward_refraction;
        		...
        		colour_changer_solid[1] = true;
        		colour_changer_solid[2] = true;
        		
        		colour_changer_1 = new Colour_Changer();
                colour_changer_1.position.set( 60, 10, 0 );
                colour_changers.add(colour_changer_1);
                colour_changer_2 = new Colour_Changer();
                colour_changer_2.position.set( -30, 10, 0 );
                colour_changers.add(colour_changer_2);
                
                colour_changer_colour[1] = geel;
                ...
                block_1 = new Block( new Vector( 40, 40, 0 ));
                blocks.add( block_1 );
                block_2 = new Block( new Vector( 40, 30, 0 ));
                blocks.add( block_2 );
                block_3 = new Block( new Vector( 40, 10, 0 ));
                blocks.add( block_3 );
                block_4 = new Block( new Vector( 40, -10, 0 ));
                blocks.add( block_4 );
                block_5 = new Block( new Vector( 40, -20, 0 ));
                blocks.add( block_5 );
                block_6 = new Block( new Vector( 40, -40, 0 ));
                blocks.add( block_6 );
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		mirrors.get(1).position.set( new Vector( 30, 30, 0 ));
        		mirrors.get(2).position.set( new Vector( 50, 30, 0 ));
        		mirrors.get(3).position.set( new Vector( 50, -20, 0 ));
        		mirrors.get(4).position.set( new Vector( -50, 0, 0 ));
        		mirrors.get(5).position.set( new Vector( -70, -20, 0 ));
        		mirrors.get(6).position.set( new Vector( 0, 10, 0 ));
        		mirrors.get(7).position.set( new Vector( -10, 30, 0 ));
        		mirrors.get(8).position.set( new Vector( 30, 20, 0 ));
        		mirrors.get(9).position.set( new Vector( -60, 20, 0 ));
        	}
        }
