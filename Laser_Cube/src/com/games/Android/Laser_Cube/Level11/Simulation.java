package com.games.Android.Laser_Cube.Level11;
...
{   
        ...
        public Simulation( Level11 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		radiation_tile_1 = new Radiation_Tile( new Vector( 50, -10, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 40, 0, 0));
        		...
        		radiation_tile_4 = new Radiation_Tile( new Vector( 40, -20, 0));
        		...
        		block_1 = new Block( new Vector ( 50, 0, 0 ) );
                blocks.add(block_1);
                block_2 = new Block( new Vector ( 50, -20, 0 ) );
                blocks.add(block_2);
                block_3 = new Block( new Vector ( 40, -10, 0 ) );
                blocks.add(block_3);
                block_4 = new Block( new Vector ( 30, 0, 0 ) );
                blocks.add(block_4);
                block_5 = new Block( new Vector ( 30, -20, 0 ) );
                blocks.add(block_5);
        		...
        		mirror_shape[3] = triple_refraction;
        		...
        		mirror_shape[12] = triple_refraction;
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		...
        		mirrors.get(1).position.set( new Vector( 80, -40, 0 ));
        		mirrors.get(2).position.set( new Vector( -80, 40, 0 ));
