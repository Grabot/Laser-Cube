...
public class Level11 implements Screen
{
	...
	public Level11( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_11_Game", 2 );
			...
			if( prefs.getInteger("Level_16_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_16_Game", 1 );
			}
			prefs.flush();
		}
	}
