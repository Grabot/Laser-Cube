...
public class Renderer
{
	...
	public Renderer( Init_Renderer init )
	{
		...
		this.init = init;
        Gdx.app.log( Renderer.LOG, "Level 11" );
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(3), rotate_mirrors[3], true, triple_refraction );
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(12), rotate_mirrors[12], false, triple_refraction );
