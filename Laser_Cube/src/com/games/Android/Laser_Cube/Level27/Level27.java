...
public class Level27 implements Screen
{
	...
	public Level27( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_27_Game", 2 );
			...
			if( prefs.getInteger("Level_28_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_28_Game", 1 );
			}
			if( prefs.getInteger("Level_22_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_22_Game", 1 );
			}
			if( prefs.getInteger("Level_32_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_32_Game", 1 );
			}
			prefs.flush();
		}
	}
