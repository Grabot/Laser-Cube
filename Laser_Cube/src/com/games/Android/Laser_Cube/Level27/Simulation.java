package com.games.Android.Laser_Cube.Level27;
...
{   
        ...
        public Simulation( Level27 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		//green
        		radiation_tile_1 = new Radiation_Tile( new Vector( 50, -20, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 30, 0, 0));
        		radiation_tiles.add( radiation_tile_2 );
        		radiation_tile_3 = new Radiation_Tile( new Vector( 0, -20, 0));
        		...
        		//red
        		radiation_tile_5 = new Radiation_Tile( new Vector( 50, 10, 0));
        		...
        		radiation_tile_7 = new Radiation_Tile( new Vector( -20, 10, 0));
        		...
        		//yellow
        		radiation_tile_10 = new Radiation_Tile( new Vector( 50, 30, 0));
        		radiation_tiles.add( radiation_tile_10 );
        		radiation_tile_11 = new Radiation_Tile( new Vector( -20, 30, 0));
                ...
                colour_changer_1.position.set( 0, -40, 0 );
        ...
        private void Pause_Actions()
        {
        	...
        	{        		
        		...
        		mirrors.get(4).position.set( new Vector( -30, 30, 0 ));
