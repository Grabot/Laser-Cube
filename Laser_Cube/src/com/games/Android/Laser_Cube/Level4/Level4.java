...
public class Level4 implements Screen
{
	...
	public Level4( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
		
		prefs = Gdx.app.getPreferences("my-preferences");
        
        simulation = new Simulation( this, main, prefs.getBoolean( "help_level_4", true ) );
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putBoolean( "help_level_4", false );
			prefs.putInteger("Level_4_Game", 2 );
