...
{   
        ...
        public Simulation( Level4 level, Main main, boolean help )
        {
        		this.help = help;
        		this.level = level;
        		this.main = main;
        ...
        public void populate( )
        {
        		...
        		cube_red_1 = new Cube();
        		cube_red_1.position.set( 80, 0, 0 );
        		cubes.add(cube_red_1);
        		
        		mirror_1 = new Mirror();
        		mirror_1.position.set( 60, 10, 0 );
        		mirrors.add(mirror_1);
        		mirror_2 = new Mirror();
        		mirror_2.position.set( -10, 20, 0 );
        		mirrors.add(mirror_2);
        		mirror_3 = new Mirror();
        		mirror_3.position.set( 10, 10, 0 );
        		mirrors.add(mirror_3);
        		mirror_4 = new Mirror();
        		mirror_4.position.set( 30, -20, 0 );
        		mirrors.add(mirror_4);
        		
        		radiation_tile_1 = new Radiation_Tile( new Vector( 40, 0, 0));
        		...
        		block_1 = new Block( new Vector( 0, 0, 0 ));
        		blocks.add(block_1);
        		
        		block_2 = new Block( new Vector( -40, 40, 0 ));
        		blocks.add(block_2);
        		block_3 = new Block( new Vector( -40, 30, 0 ));
        		blocks.add(block_3);
        		block_4 = new Block( new Vector( -40, 20, 0 ));
        		blocks.add(block_4);
        		block_5 = new Block( new Vector( -40, 10, 0 ));
        		blocks.add(block_5);
        		block_6 = new Block( new Vector( -40, -10, 0 ));
        		blocks.add(block_6);
        		block_7 = new Block( new Vector( -40, -20, 0 ));
        		blocks.add(block_7);
        		block_8 = new Block( new Vector( -40, -30, 0 ));
        		blocks.add(block_8);
        		block_9 = new Block( new Vector( -40, -40, 0 ));
        		blocks.add(block_9);
        ...
        private void check_touched_field()
        {
        	if( (touch_distance_x < 80 && touch_distance_x > -80) && (touch_distance_y > -40 && touch_distance_y < 40 ))
        	{
        		help = false;
        	}
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector(  80, 0, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 60, 10, 0 ));
        		mirrors.get(2).position.set( new Vector( -10, 20, 0 ));
        		mirrors.get(3).position.set( new Vector( 10, 10, 0 ));
