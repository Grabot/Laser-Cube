...
{   
        ...
        public Simulation( Level5 level, Main main, boolean help )
        {
        		this.help = help;
        		this.level = level;
        		this.main = main;
        ...
        public void populate( )
        {
        		...
        		cube_green = new Cube();
        		cube_green.position.set( 20, -40, 0 );
        		cubes.add(cube_green);
        		cube_red = new Cube();
        		cube_red.position.set( -20, -40, 0 );
        		cubes.add(cube_red);
        		
        		radiation_tile_1 = new Radiation_Tile( new Vector( 20, 30, 0));
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector(  20, -40, 0 ));
