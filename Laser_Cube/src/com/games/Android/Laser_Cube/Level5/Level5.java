...
public class Level5 implements Screen
{
	...
	public Level5( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
		
		prefs = Gdx.app.getPreferences("my-preferences");
        
        simulation = new Simulation( this, main, prefs.getBoolean( "help_level_5", true ) );
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putBoolean( "help_level_5", false );
			prefs.putInteger( "Level_5_Game", 2 );
