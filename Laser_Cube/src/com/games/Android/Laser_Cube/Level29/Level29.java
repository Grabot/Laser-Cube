...
public class Level29 implements Screen
{
	...
	public Level29( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_29_Game", 2 );
			if( prefs.getInteger("Level_30_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_30_Game", 1 );
			}
