...
{   
        ...
        public Simulation( Level29 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green = new Cube();
        		cube_green.position.set( 70, -30, 0 );
        		cubes.add(cube_green);
        		cube_red = new Cube();
        		cube_red.position.set( -80, -20, 0 );
        		cubes.add(cube_red);
        		cube_yellow = new Cube();
        		cube_yellow.position.set( 0, 30, 0 );
        		...
        		radiation_tile_4 = new Radiation_Tile( new Vector( -30, 30, 0));
        		radiation_tiles.add( radiation_tile_4 );
        		radiation_tile_5 = new Radiation_Tile( new Vector( 0, 0, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		
        		mirror_1 = new Mirror();
        		mirror_1.position.set( 80, 0, 0 );
        		...
        		mirror_8 = new Mirror();
        		mirror_8.position.set( 80, -40, 0 );
        		mirrors.add(mirror_8);
        		mirror_9 = new Mirror();
        		mirror_9.position.set( -60, -40, 0 );
        		mirrors.add(mirror_9);
        		mirror_10 = new Mirror();
        		mirror_10.position.set( -60, 30, 0 );
        		mirrors.add(mirror_10);
        		
        		block_1 = new Block( new Vector( -10, 10, 0 ));
                blocks.add( block_1 );
                block_2 = new Block( new Vector( -10, 0, 0 ));
                blocks.add( block_2 );
                block_3 = new Block( new Vector( 0, -10, 0 ));
                blocks.add( block_3 );
                block_4 = new Block( new Vector( 10, 0, 0 ));
                blocks.add( block_4 );
                block_5 = new Block( new Vector( 10, 10, 0 ));
                blocks.add( block_5 );
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		mirrors.get(1).position.set( new Vector( 80, 0, 0 ));
