...
{   
        ...
        public Simulation( Level8 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green_1.position.set( 70, -40, 0 );
        		...
        		mirror_2 = new Mirror();
        		mirror_2.position.set( 30, 0, 0 );
        		mirrors.add(mirror_2);
        		mirror_3 = new Mirror();
        		mirror_3.position.set( -30, -10, 0 );
        		mirrors.add(mirror_3);
        		mirror_4 = new Mirror();
        		mirror_4.position.set( 40, 20, 0 );
        		mirrors.add(mirror_4);
        		mirror_5 = new Mirror();
        		mirror_5.position.set( -50, 10, 0 );
        		mirrors.add(mirror_5);
        		mirror_6 = new Mirror();
        		mirror_6.position.set( 50, -30, 0 );
        		mirrors.add(mirror_6);
        		mirror_7 = new Mirror();
        		mirror_7.position.set( -70, 20, 0 );
        		mirrors.add(mirror_7);
        		mirror_8 = new Mirror();
        		mirror_8.position.set( 0, 20, 0 );
        		mirrors.add(mirror_8);
        		mirror_9 = new Mirror();
        		mirror_9.position.set( 70, 30, 0 );
        		mirrors.add(mirror_9);
        		mirror_10 = new Mirror();
        		mirror_10.position.set( 0, -10, 0 );
        		mirrors.add(mirror_10);
        		
        		radiation_tile_1 = new Radiation_Tile( new Vector( 50, -40, 0));
        		...
        		radiation_tile_3 = new Radiation_Tile( new Vector( -70, 40, 0));
        		radiation_tiles.add( radiation_tile_3 );
        		
        		block_1 = new Block( new Vector( 30, 40, 0 ));
        		blocks.add(block_1);
        		block_2 = new Block( new Vector( 30, 30, 0 ));
        		blocks.add(block_2);
        		block_3 = new Block( new Vector( 30, 20, 0 ));
        		blocks.add(block_3);
        		block_4 = new Block( new Vector( 30, 10, 0 ));
        		blocks.add(block_4);
        		block_5 = new Block( new Vector( 30, -10, 0 ));
        		blocks.add(block_5);
        		block_6 = new Block( new Vector( 30, -30, 0 ));
        		blocks.add(block_6);
        		block_7 = new Block( new Vector( 30, -40, 0 ));
        		blocks.add(block_7);
        		block_8 = new Block( new Vector( -30, 40, 0 ));
        		blocks.add(block_8);
        		block_9 = new Block( new Vector( -30, 30, 0 ));
        		blocks.add(block_9);
        		block_10 = new Block( new Vector( -30, 20, 0 ));
        		blocks.add(block_10);
        		block_11 = new Block( new Vector( -30, 10, 0 ));
        		blocks.add(block_11);
        		block_12 = new Block( new Vector( -30, 0, 0 ));
        		blocks.add(block_12);
        		block_13 = new Block( new Vector( -30, -20, 0 ));
        		blocks.add(block_13);
        		block_14 = new Block( new Vector( -30, -30, 0 ));
        		blocks.add(block_14);
        		block_15 = new Block( new Vector( -30, -40, 0 ));
        		blocks.add(block_15);
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( 70, -40, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 30, -20, 0 ));
        		mirrors.get(2).position.set( new Vector( 30, 0, 0 ));
        		mirrors.get(3).position.set( new Vector( -30, -10, 0 ));
        		mirrors.get(4).position.set( new Vector( 40, 20, 0 ));
        		mirrors.get(5).position.set( new Vector( -50, 10, 0 ));
        		mirrors.get(6).position.set( new Vector( 50, -30, 0 ));
        		mirrors.get(7).position.set( new Vector( -70, 20, 0 ));
        		mirrors.get(8).position.set( new Vector( 0, 20, 0 ));
        		mirrors.get(9).position.set( new Vector( 70, 30, 0 ));
        		mirrors.get(10).position.set( new Vector( 0, -10, 0 ));
