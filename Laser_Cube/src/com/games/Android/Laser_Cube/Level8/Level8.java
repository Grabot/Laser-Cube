...
public class Level8 implements Screen
{
	...
	public Level8( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_8_Game", 2 );
			...
			if( prefs.getInteger("Level_3_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_3_Game", 1 );
			}
			prefs.flush();
		}
	}
