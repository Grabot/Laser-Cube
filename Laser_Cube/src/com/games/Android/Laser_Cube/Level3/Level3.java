...
public class Level3 implements Screen
{
	...
	public Level3( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
		
		prefs = Gdx.app.getPreferences("my-preferences");
        
        simulation = new Simulation( this, main, prefs.getBoolean("help_level_3", true ) );
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putBoolean("help_level_3", false );
			prefs.putInteger("Level_3_Game", 2 );
