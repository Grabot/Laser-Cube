package com.games.Android.Laser_Cube.Level3;
...
{   
        ...
        public Simulation( Level3 level, Main main, boolean help )
        {
        		this.help = help;
        		this.level = level;
        		this.main = main;
        ...
        public void populate( )
        {
        		...
        		cube_green_1.position.set( 80, 0, 0 );
        		cubes.add(cube_green_1);
        		cube_yellow_1 = new Cube();
        		cube_yellow_1.position.set( 80, -20, 0 );
        		cubes.add(cube_yellow_1);
        		cube_red_1 = new Cube();
        		cube_red_1.position.set( 80, -40, 0 );
        		cubes.add(cube_red_1);
        		
        		radiation_tile_1 = new Radiation_Tile( new Vector( 30, 30, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 0, 30, 0));
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		...
        		cubes.get(2).position.set( new Vector( 80, -20, 0 ));
        		cubes.get(3).position.set( new Vector( 80, -40, 0 ));
