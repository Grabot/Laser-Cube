...
{   
        ...
        public Radiation_Tile radiation_tile_16;
        ...
        public Simulation( Level17 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_yellow.position.set( 0, -20, 0 );
        		cubes.add(cube_yellow);
        		cube_red = new Cube();
        		cube_red.position.set( 20, -40, 0 );
        		cubes.add(cube_red);
        		
        		radiation_tile_1 = new Radiation_Tile( new Vector( 80, -20, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 60, 30, 0));
        		radiation_tiles.add( radiation_tile_2 );
        		radiation_tile_3 = new Radiation_Tile( new Vector( 50, -20, 0));
        		radiation_tiles.add( radiation_tile_3 );
        		radiation_tile_4 = new Radiation_Tile( new Vector( 0, 30, 0));
        		radiation_tiles.add( radiation_tile_4 );
        		radiation_tile_5 = new Radiation_Tile( new Vector( -30, -40, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		radiation_tile_6 = new Radiation_Tile( new Vector( -80, 30, 0));
        		...
        		radiation_tile_8 = new Radiation_Tile( new Vector( 60, 20, 0));
        		radiation_tiles.add( radiation_tile_8 );
        		radiation_tile_9 = new Radiation_Tile( new Vector( 40, -10, 0));
        		radiation_tiles.add( radiation_tile_9 );
        		radiation_tile_10 = new Radiation_Tile( new Vector( 40, -40, 0));
        		radiation_tiles.add( radiation_tile_10 );
        		radiation_tile_11 = new Radiation_Tile( new Vector( 0, 20, 0));
        		radiation_tiles.add( radiation_tile_11 );
        		radiation_tile_12 = new Radiation_Tile( new Vector( -20, -30, 0));
        		radiation_tiles.add( radiation_tile_12 );
        		radiation_tile_13 = new Radiation_Tile( new Vector( -50, -10, 0));
        		radiation_tiles.add( radiation_tile_13 );
        		radiation_tile_14 = new Radiation_Tile( new Vector( -60, 20, 0));
        		radiation_tiles.add( radiation_tile_14 );
        		radiation_tile_15 = new Radiation_Tile( new Vector( -60, -40, 0));
        		radiation_tiles.add( radiation_tile_15 );
        		radiation_tile_16 = new Radiation_Tile( new Vector( -80, 40, 0));
        		radiation_tiles.add( radiation_tile_16 );
        		...
        		mirror_3 = new Mirror();
        		mirror_3.position.set( -10, -30, 0 );
        		mirrors.add(mirror_3);
        		mirror_4 = new Mirror();
        		mirror_4.position.set( -20, 0, 0 );
        		mirrors.add(mirror_4);
        		mirror_5 = new Mirror();
        		mirror_5.position.set( -50, -30, 0 );
        		mirrors.add(mirror_5);
        		mirror_6 = new Mirror();
        		mirror_6.position.set( 60, 0, 0 );
        		mirrors.add(mirror_6);
        		mirror_7 = new Mirror();
        		mirror_7.position.set( -20, 30, 0 );
        		mirrors.add(mirror_7);
        		mirror_8 = new Mirror();
        		mirror_8.position.set( -60, -20, 0 );
        		mirrors.add(mirror_8);
        		mirror_9 = new Mirror();
        		mirror_9.position.set( 0, 0, 0 );
        		mirrors.add(mirror_9);
        		
        		mirror_shape[1] = double_refraction;
        		mirror_shape[2] = double_refraction;
                ...
                radiation_tiles_colour[16] = geel;
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( 0, -20, 0 ));
        		cubes.get(2).position.set( new Vector( 20, -40, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 50, -30, 0 ));
        		mirrors.get(2).position.set( new Vector( 20, 20, 0 ));
        		mirrors.get(3).position.set( new Vector( -10, -30, 0 ));
        		mirrors.get(4).position.set( new Vector( -20, 0, 0 ));
        		mirrors.get(5).position.set( new Vector( -50, -30, 0 ));
        		mirrors.get(6).position.set( new Vector( 60, 0, 0 ));
        		mirrors.get(7).position.set( new Vector( -20, 30, 0 ));
        		mirrors.get(8).position.set( new Vector( -60, -20, 0 ));
        		mirrors.get(9).position.set( new Vector( 0, 0, 0 ));
