...
public class Level23 implements Screen
{
	...
	public Level23( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_23_Game", 2 );
			if( prefs.getInteger("Level_24_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_24_Game", 1 );
			}
