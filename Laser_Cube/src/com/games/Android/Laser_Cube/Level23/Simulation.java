...
{   
        ...
        public Simulation( Level23 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green = new Cube();
        		cube_green.position.set( 0, 0, 0 );
        		cubes.add(cube_green);
        		
        		//green
        		radiation_tile_1 = new Radiation_Tile( new Vector( 70, -30, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 60, 20, 0));
        		radiation_tiles.add( radiation_tile_2 );
        		radiation_tile_3 = new Radiation_Tile( new Vector( 40, 10, 0));
        		radiation_tiles.add( radiation_tile_3 );
        		radiation_tile_4 = new Radiation_Tile( new Vector( 20, 40, 0));
        		radiation_tiles.add( radiation_tile_4 );
        		radiation_tile_5 = new Radiation_Tile( new Vector( 0, -20, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		radiation_tile_6 = new Radiation_Tile( new Vector( -40, 20, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( -40, 40, 0));
        		...
        		mirror_shape[19] = single_refraction;
        		mirror_shape[20] = single_refraction;
        		mirror_shape[21] = single_refraction;
        		mirror_shape[22] = single_refraction;
        		mirror_shape[23] = single_refraction;
        		mirror_shape[24] = single_refraction;
        		mirror_shape[25] = single_refraction;
        		mirror_shape[26] = single_refraction;
        		mirror_shape[27] = single_refraction;
        		mirror_shape[28] = single_refraction;
        		mirror_shape[29] = double_refraction;
        		...
        		mirror_solid[13] = true;
        		mirror_solid[14] = true;
        		mirror_solid[15] = true;
        		mirror_solid[16] = true;
        		mirror_solid[17] = true;
        		mirror_solid[18] = true;
        		mirror_solid[19] = true;
        		mirror_solid[20] = true;
        		mirror_solid[21] = true;
        		mirror_solid[22] = true;
        		mirror_solid[23] = true;
        		mirror_solid[24] = true;
        		mirror_solid[25] = true;
        		mirror_solid[26] = true;
        		mirror_solid[27] = true;
        		mirror_solid[28] = true;
        		mirror_solid[29] = true;
        	    ...
        	    rotate_mirrors[1] = 90;
        	    rotate_mirrors[2] = 0;
        	    rotate_mirrors[4] = 270;
        	    
        	    rotate_mirrors[6] = 270;
        	    rotate_mirrors[7] = 180;
        	    rotate_mirrors[9] = 180;
        	    rotate_mirrors[11] = 180;
        	    rotate_mirrors[13] = 180;
        	    rotate_mirrors[15] = 180;
        	    rotate_mirrors[17] = 90;
        	    rotate_mirrors[19] = 180;
        	    rotate_mirrors[21] = 180;
        	    rotate_mirrors[23] = 180;
        	    rotate_mirrors[25] = 180;
        	    rotate_mirrors[27] = 180;
        	    rotate_mirrors[29] = 180;
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( 0, 0, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( -50, -30, 0 ));
        		mirrors.get(2).position.set( new Vector( 20, -20, 0 ));
        		mirrors.get(3).position.set( new Vector( 40, 30, 0 ));
        		mirrors.get(4).position.set( new Vector( -70, 30, 0 ));
        		mirrors.get(5).position.set( new Vector( 70, 20, 0 ));
        	}
        }
