...
{   
        ...
        public Simulation( Level10 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green_1.position.set( 50, -20, 0 );
        		cubes.add(cube_green_1);
        		cube_green_2 = new Cube();
        		cube_green_2.position.set( 20, -40, 0 );
        		cubes.add(cube_green_2);
        		cube_green_3 = new Cube();
        		cube_green_3.position.set( -40, 20, 0 );
        		cubes.add(cube_green_3);
        		cube_green_4 = new Cube();
        		cube_green_4.position.set( -40, -40, 0 );
        		cubes.add(cube_green_4);
        		
        		radiation_tile_1 = new Radiation_Tile( new Vector( 40, -40, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( -20, 30, 0));
        		radiation_tiles.add( radiation_tile_2 );
        		radiation_tile_3 = new Radiation_Tile( new Vector( -80, -10, 0));
        		radiation_tiles.add( radiation_tile_3 );
        		radiation_tile_4 = new Radiation_Tile( new Vector( 80, -10, 0));
                ...
                colour_changer_1.position.set( 60, 20, 0 );
                colour_changers.add(colour_changer_1);
                colour_changer_2 = new Colour_Changer();
                colour_changer_2.position.set( -60, -10, 0 );
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		...
        		cubes.get(3).position.set( new Vector( -40, 20, 0 ));
        		cubes.get(4).position.set( new Vector( -40, -40, 0 ));
        		...
        		colour_changers.get(1).position.set( new Vector( 60, 20, 0 ));
        		colour_changers.get(2).position.set( new Vector( -60, -10, 0 ));
