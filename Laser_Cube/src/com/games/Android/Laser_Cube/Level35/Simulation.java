package com.games.Android.Laser_Cube.Level35;
...
{   
        ...
        public Simulation( Level35 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green_1.position.set( 10, 40, 0 );
        		cubes.add(cube_green_1);
        		cube_green_2 = new Cube();
        		cube_green_2.position.set( -10, -40, 0 );
        		...
        		radiation_tile_3 = new Radiation_Tile( new Vector( 10, -20, 0));
        		...
        		radiation_tile_5 = new Radiation_Tile( new Vector( -30, 20, 0));
        		...
        		radiation_tile_7 = new Radiation_Tile( new Vector( 30, 30, 0));
        		radiation_tiles.add( radiation_tile_7 );
        		radiation_tile_8 = new Radiation_Tile( new Vector( 0, -10, 0));
        		radiation_tiles.add( radiation_tile_8 );
        		radiation_tile_9 = new Radiation_Tile( new Vector( -60, -30, 0));
        		radiation_tiles.add( radiation_tile_9 );
        		radiation_tile_10 = new Radiation_Tile( new Vector( -60, 30, 0));
        		radiation_tiles.add( radiation_tile_10 );
        		
        		mirror_1 = new Mirror();
        		mirror_1.position.set( 70, 30, 0 );
        		...
        		blocks.add( block_1 );
        		block_2 = new Block( new Vector( 10, 10, 0 ));
        		blocks.add( block_2 );
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		mirrors.get(1).position.set( new Vector( 70, 30, 0 ));
        		...
        		mirrors.get(5).position.set( new Vector( -80, 10, 0 ));
        		mirrors.get(6).position.set( new Vector( -10, 40, 0 ));
        		mirrors.get(7).position.set( new Vector( 10, -10, 0 ));
        		mirrors.get(8).position.set( new Vector( -80, -20, 0 ));
        	}
        }
