...
{   
        ...
        public Simulation( Level12 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green = new Cube();
        		cube_green.position.set( 50, 20, 0 );
        		cubes.add(cube_green);
        		
        		radiation_tile_1 = new Radiation_Tile( new Vector( 30, 20, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 30, -10, 0));
        		radiation_tiles.add( radiation_tile_2 );
        		radiation_tile_3 = new Radiation_Tile( new Vector( 20, -20, 0));
        		...
        		mirror_shape[18] = triple_refraction;
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( 50, 20, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 30, 0, 0 ));
        		mirrors.get(2).position.set( new Vector( 20, 20, 0 ));
        		mirrors.get(3).position.set( new Vector( 10, 20, 0 ));
        		mirrors.get(4).position.set( new Vector( 0, -20, 0 ));
        		mirrors.get(5).position.set( new Vector( -10, 10, 0 ));
        		mirrors.get(6).position.set( new Vector( -10, 0, 0 ));
        		mirrors.get(7).position.set( new Vector( -10, -10, 0 ));
        		mirrors.get(8).position.set( new Vector( 80, 10, 0 ));
        		mirrors.get(9).position.set( new Vector( 80, 0, 0 ));
        		mirrors.get(10).position.set( new Vector( -80, 10, 0 ));
        		mirrors.get(11).position.set( new Vector( -80, 0, 0 ));
        		mirrors.get(12).position.set( new Vector( 60, 30, 0 ));
        		mirrors.get(13).position.set( new Vector( -30, 30, 0 ));
        		mirrors.get(14).position.set( new Vector( -30, -30, 0 ));
        		mirrors.get(15).position.set( new Vector( -40, 0, 0 ));
        		mirrors.get(16).position.set( new Vector( -50, 30, 0 ));
        		mirrors.get(17).position.set( new Vector( -60, 10, 0 ));
        		mirrors.get(18).position.set( new Vector( 0, 0, 0 ));
