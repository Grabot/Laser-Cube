...
public class Level12 implements Screen
{
	...
	public Level12( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_12_Game", 2 );
			...
			if( prefs.getInteger("Level_11_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_11_Game", 1 );
			}
