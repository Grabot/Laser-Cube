...
{   
        ...
        public Cube cube_yellow_1;
        public Cube cube_yellow_2;
        public Cube cube_yellow_3;
        public Cube cube_yellow_4;
        public Cube cube_yellow_5;
        public Cube cube_yellow_6;
        ...
        public Block block_27;
        public Block block_28;
        ...
        public Simulation( Level39 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_yellow_1 = new Cube();
        		cube_yellow_1.position.set( 50, -40, 0 );
        		cubes.add(cube_yellow_1);
        		cube_yellow_2 = new Cube();
        		cube_yellow_2.position.set( 0, -40, 0 );
        		cubes.add(cube_yellow_2);
        		cube_yellow_3 = new Cube();
        		cube_yellow_3.position.set( -50, -40, 0 );
        		cubes.add(cube_yellow_3);
        		cube_yellow_4 = new Cube();
        		cube_yellow_4.position.set( 50, 40, 0 );
        		cubes.add(cube_yellow_4);
        		cube_yellow_5 = new Cube();
        		cube_yellow_5.position.set( 0, 40, 0 );
        		cubes.add(cube_yellow_5);
        		cube_yellow_6 = new Cube();
        		cube_yellow_6.position.set( -50, 40, 0 );
        		cubes.add(cube_yellow_6);
        		
        		//yellow
        		radiation_tile_1 = new Radiation_Tile( new Vector( 80, -20, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 80, 20, 0));
        		...
        		radiation_tile_4 = new Radiation_Tile( new Vector( 30, 20, 0));
        		radiation_tiles.add( radiation_tile_4 );
        		radiation_tile_5 = new Radiation_Tile( new Vector( 10, 0, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		radiation_tile_6 = new Radiation_Tile( new Vector( -10, 0, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( -30, -20, 0));
        		...
        		radiation_tile_9 = new Radiation_Tile( new Vector( -80, 20, 0));
        		radiation_tiles.add( radiation_tile_9 );
        		radiation_tile_10 = new Radiation_Tile( new Vector( -80, -20, 0));
        		radiation_tiles.add( radiation_tile_10 );
        		
        		mirror_1 = new Mirror();
        		mirror_1.position.set( 70, -20, 0 );
        		mirrors.add(mirror_1);
        		mirror_2 = new Mirror();
        		mirror_2.position.set( 50, 10, 0 );
        		mirrors.add(mirror_2);
        		mirror_3 = new Mirror();
        		mirror_3.position.set( 0, 0, 0 );
        		mirrors.add(mirror_3);
        		mirror_4 = new Mirror();
        		mirror_4.position.set( -40, 10, 0 );
        		mirrors.add(mirror_4);
        		mirror_5 = new Mirror();
        		mirror_5.position.set( -60, 30, 0 );
        		mirrors.add(mirror_5);
        		mirror_6 = new Mirror();
        		mirror_6.position.set( -60, -20, 0 );
        		mirrors.add(mirror_6);
        		mirror_7 = new Mirror();
        		mirror_7.position.set( -70, 10, 0 );
        		mirrors.add(mirror_7);
        		mirror_8 = new Mirror();
        		mirror_8.position.set( 60, 0, 0 );
        		mirrors.add(mirror_8);
        		
        		block_1 = new Block( new Vector( 50, 20, 0 ));
        		blocks.add( block_1 );
        		block_2 = new Block( new Vector( 40, 30, 0 ));
        		blocks.add( block_2 );
        		block_3 = new Block( new Vector( 30, 40, 0 ));
        		blocks.add( block_3 );
        		block_4 = new Block( new Vector( 20, 40, 0 ));
        		blocks.add( block_4 );
        		block_5 = new Block( new Vector( 10, 30, 0 ));
        		blocks.add( block_5 );
        		block_6 = new Block( new Vector( -50, 20, 0 ));
        		blocks.add( block_6 );
        		block_7 = new Block( new Vector( -40, 30, 0 ));
        		blocks.add( block_7 );
        		block_8 = new Block( new Vector( -30, 40, 0 ));
        		blocks.add( block_8 );
        		block_9 = new Block( new Vector( -20, 40, 0 ));
        		blocks.add( block_9 );
        		block_10 = new Block( new Vector( -10, 30, 0 ));
        		blocks.add( block_10 );
        		block_11 = new Block( new Vector( 30, 0, 0 ));
        		blocks.add( block_11 );
        		block_12 = new Block( new Vector( 20, 0, 0 ));
        		blocks.add( block_12 );
        		block_13 = new Block( new Vector( 10, -10, 0 ));
        		blocks.add( block_13 );
        		block_14 = new Block( new Vector( 10, 10, 0 ));
        		blocks.add( block_14 );
        		block_15 = new Block( new Vector( -30, 0, 0 ));
        		blocks.add( block_15 );
        		block_16 = new Block( new Vector( -20, 0, 0 ));
        		blocks.add( block_16 );
        		block_17 = new Block( new Vector( -10, -10, 0 ));
        		blocks.add( block_17 );
        		block_18 = new Block( new Vector( -10, 10, 0 ));
        		blocks.add( block_18 );
        		block_19 = new Block( new Vector( 50, -20, 0 ));
        		blocks.add( block_19 );
        		block_20 = new Block( new Vector( 40, -30, 0 ));
        		blocks.add( block_20 );
        		block_21 = new Block( new Vector( 30, -40, 0 ));
        		blocks.add( block_21 );
        		block_22 = new Block( new Vector( 20, -40, 0 ));
        		blocks.add( block_22 );
        		block_23 = new Block( new Vector( 10, -30, 0 ));
        		blocks.add( block_23 );
        		block_24 = new Block( new Vector( -50, -20, 0 ));
        		blocks.add( block_24 );
        		block_25 = new Block( new Vector( -40, -30, 0 ));
        		blocks.add( block_25 );
        		block_26 = new Block( new Vector( -30, -40, 0 ));
        		blocks.add( block_26 );
        		block_27 = new Block( new Vector( -20, -40, 0 ));
        		blocks.add( block_27 );
        		block_28 = new Block( new Vector( -10, -30, 0 ));
        		blocks.add( block_28 );
        		...
        		mirror_shape[7] = double_refraction;
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		mirrors.get(1).position.set( new Vector( 70, -20, 0 ));
