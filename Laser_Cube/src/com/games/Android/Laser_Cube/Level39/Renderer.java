...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Cube( gl, simulation.cubes.get(1), rotate_cubes[1], yellow, true );
        ...
        init.Build_Cube( gl, simulation.cubes.get(4), rotate_cubes[4], yellow, true );
