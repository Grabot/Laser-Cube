package com.games.Android.Laser_Cube.Level25;
...
{   
        ...
        public Simulation( Level25 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_yellow.position.set( 60, 0, 0 );
        		cubes.add(cube_yellow);
        		cube_red = new Cube();
        		cube_red.position.set( -60, 0, 0 );
        		cubes.add(cube_red);
        		
        		//yellow
        		radiation_tile_1 = new Radiation_Tile( new Vector( 80, 0, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 80, 30, 0));
        		radiation_tiles.add( radiation_tile_2 );
        		radiation_tile_3 = new Radiation_Tile( new Vector( -80, 0, 0));
        		radiation_tiles.add( radiation_tile_3 );
        		radiation_tile_4 = new Radiation_Tile( new Vector( -80, 30, 0));
        		...
        		radiation_tile_6 = new Radiation_Tile( new Vector( 0, 40, 0));
                ...
                colour_changer_1.position.set( 60, 30, 0 );
                colour_changers.add(colour_changer_1);
                colour_changer_2 = new Colour_Changer();
                colour_changer_2.position.set( 20, -20, 0 );
                colour_changers.add(colour_changer_2);
                
                block_1 = new Block( new Vector( 70, -10, 0 ));
                blocks.add( block_1 );
                block_2 = new Block( new Vector( 70, 0, 0 ));
                blocks.add( block_2 );
                block_3 = new Block( new Vector( 70, 10, 0 ));
                blocks.add( block_3 );
                
                block_4 = new Block( new Vector( 10, -30, 0 ));
                blocks.add( block_4 );
                block_5 = new Block( new Vector( 0, -30, 0 ));
                blocks.add( block_5 );
                block_6 = new Block( new Vector( -10, -30, 0 ));
                blocks.add( block_6 );
                
                block_7 = new Block( new Vector( 0, 0, 0 ));
                blocks.add( block_7 );
                
                block_8 = new Block( new Vector( 10, 30, 0 ));
                blocks.add( block_8 );
                block_9 = new Block( new Vector( 0, 30, 0 ));
                blocks.add( block_9 );
                block_10 = new Block( new Vector( -10, 30, 0 ));
                blocks.add( block_10 );
                
                block_11 = new Block( new Vector( -70, -10, 0 ));
                blocks.add( block_11 );
                block_12 = new Block( new Vector( -70, 0, 0 ));
                blocks.add( block_12 );
                block_13 = new Block( new Vector( -70, 10, 0 ));
                blocks.add( block_13 );
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{        		
        		mirrors.get(1).position.set( new Vector( 40, 20, 0 ));
        		mirrors.get(2).position.set( new Vector( -40, 20, 0 ));
        		mirrors.get(3).position.set( new Vector( 0, -20, 0 ));
        		mirrors.get(4).position.set( new Vector( 20, 0, 0 ));
        		mirrors.get(5).position.set( new Vector( 70, 30, 0 ));
        		mirrors.get(6).position.set( new Vector( -50, -20, 0 ));
        		
        		colour_changers.get(1).position.set( new Vector( 60, 30, 0 ));
        		colour_changers.get(2).position.set( new Vector( 20, -20, 0 ));
        	}
        }
