package com.games.Android.Laser_Cube.Level19;
...
{   
        ...
        public Simulation( Level19 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_yellow.position.set( 30, 0, 0 );
        		...
        		radiation_tile_4 = new Radiation_Tile( new Vector( 40, 40, 0));
        		radiation_tiles.add( radiation_tile_4 );
        		radiation_tile_5 = new Radiation_Tile( new Vector( 20, 20, 0));
        		...
        		radiation_tile_8 = new Radiation_Tile( new Vector( 0, 40, 0));
        		radiation_tiles.add( radiation_tile_8 );
        		radiation_tile_9 = new Radiation_Tile( new Vector( -10, 20, 0));
        		...
        		radiation_tile_11 = new Radiation_Tile( new Vector( -29, -20, 0));
        		...
        		radiation_tile_13 = new Radiation_Tile( new Vector( -60, 0, 0));
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		...
        		cubes.get(3).position.set( new Vector( 30, 0, 0 ));
        		...
        		mirrors.get(7).position.set( new Vector( 50, 20, 0 ));
