...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Cube( gl, simulation.cubes.get(3), rotate_cubes[3], yellow, false );
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(7), rotate_mirrors[7], false, triple_refraction );
