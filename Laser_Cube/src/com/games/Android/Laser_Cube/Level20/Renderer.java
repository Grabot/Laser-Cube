...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(6), radiation_tile_touch[6], yellow );
        ...
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(11), radiation_tile_touch[11], green );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(12), radiation_tile_touch[12], green );
