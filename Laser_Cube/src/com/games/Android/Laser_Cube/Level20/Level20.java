...
public class Level20 implements Screen
{
	...
	public Level20( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_20_Game", 2 );
			...
			if( prefs.getInteger("Level_36_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_36_Game", 1 );
			}
