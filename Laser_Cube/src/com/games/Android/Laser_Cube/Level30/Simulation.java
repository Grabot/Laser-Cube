package com.games.Android.Laser_Cube.Level30;
...
{   
        ...
        public Simulation( Level30 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green = new Cube();
        		cube_green.position.set( -60, 30, 0 );
        		cubes.add(cube_green);
        		cube_red = new Cube();
        		cube_red.position.set( -40, -20, 0 );
        		cubes.add(cube_red);
        		...
        		radiation_tile_3 = new Radiation_Tile( new Vector( 20, -40, 0));
        		...
        		radiation_tile_6 = new Radiation_Tile( new Vector( 0, 10, 0));
        		...
        		radiation_tile_11 = new Radiation_Tile( new Vector( -10, 20, 0));
        		...
        		radiation_tile_13 = new Radiation_Tile( new Vector( -60, -20, 0));
        		radiation_tiles.add( radiation_tile_13 );
        		
        		mirror_1 = new Mirror();
        		mirror_1.position.set( 20, 0, 0 );
        		mirrors.add(mirror_1);
        		mirror_2 = new Mirror();
        		mirror_2.position.set( -70, 0, 0 );
        		...
        		mirror_shape[6] = triple_refraction;
                ...
                radiation_tiles_colour[13] = rood;
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( -60, 30, 0 ));
        		cubes.get(2).position.set( new Vector( -40, -20, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 20, 0, 0 ));
        		mirrors.get(2).position.set( new Vector( -70, 0, 0 ));
        		...
        		mirrors.get(6).position.set( new Vector( 0, -30, 0 ));
        	}
        }
