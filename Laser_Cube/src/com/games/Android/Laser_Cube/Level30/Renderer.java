...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(11), radiation_tile_touch[11], red );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(12), radiation_tile_touch[12], red );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(13), radiation_tile_touch[13], red );
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(6), rotate_mirrors[6], false, triple_refraction );
