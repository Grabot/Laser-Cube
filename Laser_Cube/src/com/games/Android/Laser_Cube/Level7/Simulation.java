...
{   
        ...
        public Cube cube_green_3;
        public Cube cube_green_4;
        ...
        public Simulation( Level7 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green_1.position.set( 70, 30, 0 );
        		cubes.add(cube_green_1);
        		cube_green_2 = new Cube();
        		cube_green_2.position.set( 30, 40, 0 );
        		cubes.add( cube_green_2 );
        		cube_green_3 = new Cube();
        		cube_green_3.position.set( -30, 40, 0 );
        		cubes.add( cube_green_3 );
        		cube_green_4 = new Cube();
        		cube_green_4.position.set( -70, 30, 0 );
        		cubes.add(cube_green_4);
        		cube_yellow_1 = new Cube();
        		cube_yellow_1.position.set( 60, 40, 0 );
        		cubes.add( cube_yellow_1 );
        		cube_yellow_2 = new Cube();
        		cube_yellow_2.position.set( -60, 40, 0 );
        		cubes.add( cube_yellow_2 );
        		
        		mirror_1 = new Mirror();
        		mirror_1.position.set( 70, 10, 0 );
        		...
        		mirror_4 = new Mirror();
        		mirror_4.position.set( 0, 10, 0 );
        		mirrors.add(mirror_4);
        		mirror_5 = new Mirror();
        		mirror_5.position.set( 50, -20, 0 );
        		mirrors.add(mirror_5);
        		mirror_6 = new Mirror();
        		mirror_6.position.set( -10, -10, 0 );
        		...
        		radiation_tile_4 = new Radiation_Tile( new Vector( 30, 0, 0));
        		radiation_tiles.add( radiation_tile_4 );
        		radiation_tile_5 = new Radiation_Tile( new Vector( -30, 0, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		radiation_tile_6 = new Radiation_Tile( new Vector( -30, -40, 0));
        		...
        		radiation_tile_8 = new Radiation_Tile( new Vector( -70, -20, 0));
        		radiation_tiles.add( radiation_tile_8 );
        		
        		block_1 = new Block( new Vector ( 40, 0, -1 ) );
                blocks.add(block_1);
                block_2 = new Block( new Vector ( 40, -10, -1 ) );
                blocks.add(block_2);
                block_3 = new Block( new Vector ( 30, -10, -1 ) );
                blocks.add(block_3);
                block_4 = new Block( new Vector ( 20, 0, -1 ) );
                blocks.add(block_4);
                block_5 = new Block( new Vector ( 20, -10, -1 ) );
                blocks.add(block_5);
                block_6 = new Block( new Vector ( -20, 0, -1 ) );
                blocks.add(block_6);
                block_7 = new Block( new Vector ( -20, -10, -1 ) );
                blocks.add(block_7);
                block_8 = new Block( new Vector ( -30, -10, -1 ) );
                blocks.add(block_8);
                block_9 = new Block( new Vector ( -40, 0, -1 ) );
                blocks.add(block_9);
                block_10 = new Block( new Vector ( -40, -10, -1 ) );
                blocks.add(block_10);
                block_11 = new Block( new Vector ( 20, -40, -1 ) );
                blocks.add(block_11);
                block_12 = new Block( new Vector ( -20, -40, -1 ) );
                blocks.add(block_12);
                block_13 = new Block( new Vector ( 40, -40, -1 ) );
                blocks.add(block_13);
                block_14 = new Block( new Vector ( -40, -40, -1 ) );
                blocks.add(block_14);
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( 70, 30, 0 ));
        		cubes.get(2).position.set( new Vector( 30, 40, 0 ));
        		cubes.get(3).position.set( new Vector( -30, 40, 0 ));
        		cubes.get(4).position.set( new Vector( -70, 30, 0 ));
        		cubes.get(5).position.set( new Vector( 60, 40, 0 ));
        		cubes.get(6).position.set( new Vector( -60, 40, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 70, 10, 0 ));
        		mirrors.get(2).position.set( new Vector( -50, 20, 0 ));
        		mirrors.get(3).position.set( new Vector( 0, 30, 0 ));
        		mirrors.get(4).position.set( new Vector( 0, 10, 0 ));
        		mirrors.get(5).position.set( new Vector( 50, -20, 0 ));
        		mirrors.get(6).position.set( new Vector( -10, -10, 0 ));
