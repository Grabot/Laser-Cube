...
public class Level7 implements Screen
{
	...
	public Level7( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_7_Game", 2 );
			if( prefs.getInteger("Level_12_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_12_Game", 1 );
			}
			if( prefs.getInteger("Level_6_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_6_Game", 1 );
			}
			if( prefs.getInteger("Level_8_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_8_Game", 1 );
			}
			if( prefs.getInteger("Level_2_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_2_Game", 1 );
			}
			prefs.flush();
		}
	}
