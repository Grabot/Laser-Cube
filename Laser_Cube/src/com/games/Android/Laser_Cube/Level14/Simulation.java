package com.games.Android.Laser_Cube.Level14;
...
{   
        ...
        public Simulation( Level14 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		radiation_tile_6 = new Radiation_Tile( new Vector( -40, -30, 0));
                ...
                block_1 = new Block( new Vector( 70, 20, 0 ));
                blocks.add( block_1 );
                block_2 = new Block( new Vector( 70, -30, 0 ));
                blocks.add( block_2 );
                block_3 = new Block( new Vector( 60, -10, 0 ));
                blocks.add( block_3 );
                block_4 = new Block( new Vector( 40, 20, 0 ));
                blocks.add( block_4 );
                block_5 = new Block( new Vector( 30, 40, 0 ));
                blocks.add( block_5 );
                block_6 = new Block( new Vector( 20, -20, 0 ));
                blocks.add( block_6 );
                block_7 = new Block( new Vector( 10, 30, 0 ));
                blocks.add( block_7 );
                block_8 = new Block( new Vector( 0, 30, 0 ));
                blocks.add( block_8 );
                block_9 = new Block( new Vector( -10, 20, 0 ));
                blocks.add( block_9 );
                block_10 = new Block( new Vector( -10, -40, 0 ));
                blocks.add( block_10 );
                block_11 = new Block( new Vector( -30, 40, 0 ));
                blocks.add( block_11 );
                block_12 = new Block( new Vector( -30, 0, 0 ));
                blocks.add( block_12 );
                block_13 = new Block( new Vector( -40, 40, 0 ));
                blocks.add( block_13 );
                block_14 = new Block( new Vector( -40, -40, 0 ));
                blocks.add( block_14 );
                block_15 = new Block( new Vector( -50, 40, 0 ));
                blocks.add( block_15 );
