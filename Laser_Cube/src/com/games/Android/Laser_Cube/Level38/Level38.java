...
public class Level38 implements Screen
{
	...
	public Level38( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_38_Game", 2 );
			if( prefs.getInteger("Level_37_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_37_Game", 1 );
			}
