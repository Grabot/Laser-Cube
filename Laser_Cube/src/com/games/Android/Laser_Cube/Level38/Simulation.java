package com.games.Android.Laser_Cube.Level38;
...
{   
        ...
        public Simulation( Level38 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green = new Cube();
        		cube_green.position.set( -10, 40, 0 );
        		cubes.add(cube_green);
        		
        		//green
        		radiation_tile_1 = new Radiation_Tile( new Vector( 60, 20, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 30, 40, 0));
        		radiation_tiles.add( radiation_tile_2 );
        		radiation_tile_3 = new Radiation_Tile( new Vector( 10, 30, 0));
        		...
        		//yellow
        		radiation_tile_5 = new Radiation_Tile( new Vector( 70, 0, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		radiation_tile_6 = new Radiation_Tile( new Vector( 50, -30, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( -40, -10, 0));
        		radiation_tiles.add( radiation_tile_7 );
        		radiation_tile_8 = new Radiation_Tile( new Vector( -40, -30, 0));
        		radiation_tiles.add( radiation_tile_8 );
        		
        		//red
        		radiation_tile_9 = new Radiation_Tile( new Vector( 40, 0, 0));
        		radiation_tiles.add( radiation_tile_9 );
        		radiation_tile_10 = new Radiation_Tile( new Vector( 20, -20, 0));
        		radiation_tiles.add( radiation_tile_10 );
        		radiation_tile_11 = new Radiation_Tile( new Vector( 20, 20, 0));
        		radiation_tiles.add( radiation_tile_11 );
        		radiation_tile_12 = new Radiation_Tile( new Vector( -30, 0, 0));
                ...
                radiation_tiles_colour[12] = rood;
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( -10, 40, 0 ));
        		
        		colour_changers.get(1).position.set( new Vector( 50, 10, 0 ));
        		colour_changers.get(2).position.set( new Vector( -50, 10, 0 ));
        		colour_changers.get(3).position.set( new Vector( -80, 10, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 80, 30, 0 ));
        		mirrors.get(2).position.set( new Vector( 40, -30, 0 ));
        		mirrors.get(3).position.set( new Vector( -20, 30, 0 ));
        		mirrors.get(4).position.set( new Vector( -20, -30, 0 ));
        		mirrors.get(5).position.set( new Vector( -30, 40, 0 ));
        		mirrors.get(6).position.set( new Vector( 60, -20, 0 ));
        		mirrors.get(7).position.set( new Vector( 0, 10, 0 ));
        		mirrors.get(8).position.set( new Vector( 60, 0, 0 ));
        		mirrors.get(9).position.set( new Vector( -60, 10, 0 ));
        		mirrors.get(10).position.set( new Vector( 80, -20, 0 ));
        		mirrors.get(11).position.set( new Vector( 50, 30, 0 ));
        		mirrors.get(12).position.set( new Vector( -50, 30, 0 ));
        		mirrors.get(13).position.set( new Vector( -60, 40, 0 ));
        	}
        }
