...
{   
        ...
        public Block block_13;
        public Block block_14;
        public Block block_15;
        public Block block_16;
        public Block block_17;
        public Block block_18;
        public Block block_19;
        public Block block_20;
        public Block block_21;
        public Block block_22;
        public Block block_23;
        public Block block_24;
        public Block block_25;
        public Block block_26;
        ...
        public Simulation( Level16 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		cube_green = new Cube();
        		cube_green.position.set( 80, 10, 0 );
        		cubes.add(cube_green);
        		cube_yellow = new Cube();
        		cube_yellow.position.set(-30, -40, 0 );
        		cubes.add(cube_yellow);
        		
        		radiation_tile_1 = new Radiation_Tile( new Vector( 70, -20, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 50, 40, 0));
        		radiation_tiles.add( radiation_tile_2 );
        		radiation_tile_3 = new Radiation_Tile( new Vector( 40, 0, 0));
        		radiation_tiles.add( radiation_tile_3 );
        		radiation_tile_4 = new Radiation_Tile( new Vector( 0, -20, 0));
        		radiation_tiles.add( radiation_tile_4 );
        		radiation_tile_5 = new Radiation_Tile( new Vector( -10, 20, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		radiation_tile_6 = new Radiation_Tile( new Vector( -30, -30, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( -50, 30, 0));
        		radiation_tiles.add( radiation_tile_7 );
        		radiation_tile_8 = new Radiation_Tile( new Vector( -30, 20, 0));
        		radiation_tiles.add( radiation_tile_8 );
        		radiation_tile_9 = new Radiation_Tile( new Vector( -30, 0, 0));
        		radiation_tiles.add( radiation_tile_9 );
        		radiation_tile_10 = new Radiation_Tile( new Vector( -60, 0, 0));
        		radiation_tiles.add( radiation_tile_10 );

        		mirror_1 = new Mirror();
        		mirror_1.position.set( 80, -30, 0 );
        		mirrors.add(mirror_1);
        		mirror_2 = new Mirror();
        		mirror_2.position.set( 80, 20, 0 );
        		mirrors.add(mirror_2);
        		mirror_3 = new Mirror();
        		mirror_3.position.set( 60, 20, 0 );
        		mirrors.add(mirror_3);
        		mirror_4 = new Mirror();
        		mirror_4.position.set( 60, -40, 0 );
        		mirrors.add(mirror_4);
        		mirror_5 = new Mirror();
        		mirror_5.position.set( 50, 30, 0 );
        		mirrors.add(mirror_5);
        		mirror_6 = new Mirror();
        		mirror_6.position.set( 30, 0, 0 );
        		mirrors.add(mirror_6);
        		mirror_7 = new Mirror();
        		mirror_7.position.set( 10, 10, 0 );
        		mirrors.add(mirror_7);
        		mirror_8 = new Mirror();
        		mirror_8.position.set( -10, -10, 0 );
        		mirrors.add(mirror_8);
        		mirror_9 = new Mirror();
        		mirror_9.position.set( -20, 20, 0 );
        		mirrors.add(mirror_9);
        		mirror_10 = new Mirror();
        		mirror_10.position.set( -30, 40, 0 );
        		mirrors.add(mirror_10);
        		mirror_11 = new Mirror();
        		mirror_11.position.set( -60, 20, 0 );
        		mirrors.add(mirror_11);
        		mirror_12 = new Mirror();
        		mirror_12.position.set( -70, 30, 0 );
        		mirrors.add(mirror_12);
        		mirror_13 = new Mirror();
        		mirror_13.position.set( 50, 10, 0 );
        		mirrors.add(mirror_13);
        		mirror_14 = new Mirror();
        		mirror_14.position.set( 20, -30, 0 );
        		mirrors.add(mirror_14);
        		mirror_15 = new Mirror();
        		mirror_15.position.set( -40, -30, 0 );
        		...
        		mirror_shape[15] = double_refraction;
        		...
        		mirror_solid[9] = false;
        		mirror_solid[10] = false;
        		mirror_solid[11] = false;
        		mirror_solid[12] = false;
                ...
                radiation_tiles_colour[8] = geel;
                radiation_tiles_colour[9] = geel;
                radiation_tiles_colour[10] = geel;
                
                block_1 = new Block( new Vector( 60, 30, 0 ));
                blocks.add( block_1 );
                block_2 = new Block( new Vector( 60, 10, 0 ));
                blocks.add( block_2 );
                block_3 = new Block( new Vector( 60, -10, 0 ));
                blocks.add( block_3 );
                block_4 = new Block( new Vector( 50, 10, 0 ));
                blocks.add( block_4 );
                block_5 = new Block( new Vector( 40, 30, 0 ));
                blocks.add( block_5 );
                block_6 = new Block( new Vector( 40, 10, 0 ));
                blocks.add( block_6 );
                block_7 = new Block( new Vector( 40, -10, 0 ));
                blocks.add( block_7 );
                block_8 = new Block( new Vector( 20, 30, 0 ));
                blocks.add( block_8 );
                block_9 = new Block( new Vector( 20, 10, 0 ));
                blocks.add( block_9 );
                block_10 = new Block( new Vector( 20, -10, 0 ));
                blocks.add( block_10 );
                block_11 = new Block( new Vector( 20, -20, 0 ));
                blocks.add( block_11 );
                block_12 = new Block( new Vector( 0, 30, 0 ));
                blocks.add( block_12 );
                block_13 = new Block( new Vector( 0, 10, 0 ));
                blocks.add( block_13 );
                block_14 = new Block( new Vector( 0, 0, 0 ));
                blocks.add( block_14 );
                block_15 = new Block( new Vector( 0, -10, 0 ));
                blocks.add( block_15 );
                block_16 = new Block( new Vector( -10, 30, 0 ));
                blocks.add( block_16 );
                block_17 = new Block( new Vector( -20, 30, 0 ));
                blocks.add( block_17 );
                block_18 = new Block( new Vector( -20, 10, 0 ));
                blocks.add( block_18 );
                block_19 = new Block( new Vector( -20, 0, 0 ));
                blocks.add( block_19 );
                block_20 = new Block( new Vector( -20, -10, 0 ));
                blocks.add( block_20 );
                block_21 = new Block( new Vector( -20, -20, 0 ));
                blocks.add( block_21 );
                block_22 = new Block( new Vector( -30, 30, 0 ));
                blocks.add( block_22 );
                block_23 = new Block( new Vector( -30, -10, 0 ));
                blocks.add( block_23 );
                block_24 = new Block( new Vector( -40, 30, 0 ));
                blocks.add( block_24 );
                block_25 = new Block( new Vector( -40, 20, 0 ));
                blocks.add( block_25 );
                block_26 = new Block( new Vector( -40, -10, 0 ));
                blocks.add( block_26 );
        	    ...
        	    rotate_mirrors[1] = 180;
        	    rotate_mirrors[4] = 90;
        	    rotate_mirrors[6] = 270;
        	    rotate_mirrors[7] = 180;
        	    rotate_mirrors[9] = 90;
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( 80, 10, 0 ));
        		cubes.get(2).position.set( new Vector( -30, -40, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 80, -30, 0 ));
        		mirrors.get(2).position.set( new Vector( 80, 20, 0 ));
        		mirrors.get(3).position.set( new Vector( 60, 20, 0 ));
        		mirrors.get(4).position.set( new Vector( 60, -40, 0 ));
        		mirrors.get(5).position.set( new Vector( 50, 30, 0 ));
        		mirrors.get(6).position.set( new Vector( 30, 0, 0 ));
        		mirrors.get(7).position.set( new Vector( 10, 10, 0 ));
        		mirrors.get(8).position.set( new Vector( -10, -10, 0 ));
        		mirrors.get(9).position.set( new Vector( -20, 20, 0 ));
        		mirrors.get(10).position.set( new Vector( -30, 40, 0 ));
        		mirrors.get(11).position.set( new Vector( -60, 20, 0 ));
        		mirrors.get(12).position.set( new Vector( -70, 30, 0 ));
        		mirrors.get(13).position.set( new Vector( 50, 10, 0 ));
        		mirrors.get(14).position.set( new Vector( 20, -30, 0 ));
        		mirrors.get(15).position.set( new Vector( -40, -30, 0 ));
