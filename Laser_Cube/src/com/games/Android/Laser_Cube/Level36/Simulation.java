package com.games.Android.Laser_Cube.Level36;
...
{   
        ...
        public Simulation( Level36 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		radiation_tile_2 = new Radiation_Tile( new Vector( 70, 0, 0));
        		...
        		radiation_tile_4 = new Radiation_Tile( new Vector( 50, -40, 0));
        		radiation_tiles.add( radiation_tile_4 );
        		radiation_tile_5 = new Radiation_Tile( new Vector( -40, -30, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		radiation_tile_6 = new Radiation_Tile( new Vector( -40, 0, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		radiation_tile_7 = new Radiation_Tile( new Vector( -40, 30, 0));
        		radiation_tiles.add( radiation_tile_7 );
        		radiation_tile_8 = new Radiation_Tile( new Vector( -40, 40, 0));
        		radiation_tiles.add( radiation_tile_8 );
        		radiation_tile_9 = new Radiation_Tile( new Vector( -60, 10, 0));
        		radiation_tiles.add( radiation_tile_9 );
        		radiation_tile_10 = new Radiation_Tile( new Vector( -80, 0, 0));
        		...
        		mirror_5 = new Mirror();
        		mirror_5.position.set( -30, 10, 0 );
        		mirrors.add(mirror_5);
        		
        		mirror_6 = new Mirror();
        		mirror_6.position.set( 0, 20, 0 );
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		...
        		mirrors.get(2).position.set( new Vector( 60, -30, 0 ));
        		mirrors.get(3).position.set( new Vector( -20, 30, 0 ));
        		mirrors.get(4).position.set( new Vector( -20, -30, 0 ));
        		mirrors.get(5).position.set( new Vector( -30, 10, 0 ));
        	}
        }
