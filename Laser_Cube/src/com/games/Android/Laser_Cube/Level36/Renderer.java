...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(5), rotate_mirrors[5], false, triple_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(6), rotate_mirrors[6], true, forward_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(7), rotate_mirrors[7], true, forward_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(8), rotate_mirrors[8], true, forward_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(9), rotate_mirrors[9], true, forward_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(10), rotate_mirrors[10], true, forward_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(11), rotate_mirrors[11], true, forward_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(12), rotate_mirrors[12], true, forward_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(13), rotate_mirrors[13], true, forward_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(14), rotate_mirrors[14], true, triple_refraction );
