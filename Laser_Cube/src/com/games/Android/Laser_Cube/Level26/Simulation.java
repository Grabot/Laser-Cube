package com.games.Android.Laser_Cube.Level26;
...
{   
        ...
        public Simulation( Level26 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		radiation_tile_5 = new Radiation_Tile( new Vector( -60, 0, 0));
        		...
        		radiation_tile_9 = new Radiation_Tile( new Vector( 10, 30, 0));
        		...
        		mirror_1 = new Mirror();
        		mirror_1.position.set( 40, -10, 0 );
        		mirrors.add(mirror_1);
        		mirror_2 = new Mirror();
        		mirror_2.position.set( 80, 0, 0 );
        		mirrors.add(mirror_2);
        		mirror_3 = new Mirror();
        		mirror_3.position.set( -30, 0, 0 );
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{        		
        		mirrors.get(1).position.set( new Vector( 40, -10, 0 ));
        		mirrors.get(2).position.set( new Vector( 80, 0, 0 ));
        		mirrors.get(3).position.set( new Vector( -30, 0, 0 ));
