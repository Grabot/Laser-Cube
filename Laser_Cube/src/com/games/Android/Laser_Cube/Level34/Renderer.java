...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(15), radiation_tile_touch[15], yellow );
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(10), rotate_mirrors[10], false, double_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(11), rotate_mirrors[11], false, double_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(12), rotate_mirrors[12], false, double_refraction );
        
        init.Build_Colour_Changer( gl, simulation.colour_changers.get(1), rotate_colour_changers[1], red, false );
        init.Build_Colour_Changer( gl, simulation.colour_changers.get(2), rotate_colour_changers[2], yellow, false );
