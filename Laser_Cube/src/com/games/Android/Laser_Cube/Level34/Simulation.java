package com.games.Android.Laser_Cube.Level34;
...
{   
        ...
        public Radiation_Tile radiation_tile_13;
        public Radiation_Tile radiation_tile_14;
        public Radiation_Tile radiation_tile_15;
        ...
        public Simulation( Level34 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		radiation_tile_4 = new Radiation_Tile( new Vector( -10, 10, 0));
        		radiation_tiles.add( radiation_tile_4 );
        		radiation_tile_5 = new Radiation_Tile( new Vector( -30, 30, 0));
        		radiation_tiles.add( radiation_tile_5 );
        		radiation_tile_6 = new Radiation_Tile( new Vector( -50, 10, 0));
        		radiation_tiles.add( radiation_tile_6 );
        		
        		//red
        		radiation_tile_7 = new Radiation_Tile( new Vector( 60, -40, 0));
        		radiation_tiles.add( radiation_tile_7 );
        		radiation_tile_8 = new Radiation_Tile( new Vector( 30, -40, 0));
        		radiation_tiles.add( radiation_tile_8 );
        		radiation_tile_9 = new Radiation_Tile( new Vector( 0, -20, 0));
        		...
        		//yellow
        		radiation_tile_11 = new Radiation_Tile( new Vector( 70, 40, 0));
        		radiation_tiles.add( radiation_tile_11 );
        		radiation_tile_12 = new Radiation_Tile( new Vector( 60, 10, 0));
        		radiation_tiles.add( radiation_tile_12 );
        		radiation_tile_13 = new Radiation_Tile( new Vector( 60, 30, 0));
        		radiation_tiles.add( radiation_tile_13 );
        		radiation_tile_14 = new Radiation_Tile( new Vector( 30, 40, 0));
        		radiation_tiles.add( radiation_tile_14 );
        		radiation_tile_15 = new Radiation_Tile( new Vector( -30, 40, 0));
        		radiation_tiles.add( radiation_tile_15 );
        		
        		mirror_1 = new Mirror();
        		mirror_1.position.set( 70, -20, 0 );
        		mirrors.add(mirror_1);
        		mirror_2 = new Mirror();
        		mirror_2.position.set( 50, -20, 0 );
        		mirrors.add(mirror_2);
        		mirror_3 = new Mirror();
        		mirror_3.position.set( 0, 30, 0 );
        		mirrors.add(mirror_3);
        		mirror_4 = new Mirror();
        		mirror_4.position.set( -30, -20, 0 );
        		mirrors.add(mirror_4);
        		mirror_5 = new Mirror();
        		mirror_5.position.set( 10, 20, 0 );
        		mirrors.add(mirror_5);
        		mirror_6 = new Mirror();
        		mirror_6.position.set( -10, 20, 0 );
        		mirrors.add(mirror_6);
        		mirror_7 = new Mirror();
        		mirror_7.position.set( 10, -30, 0 );
        		mirrors.add(mirror_7);
        		mirror_8 = new Mirror();
        		mirror_8.position.set( -10, -10, 0 );
        		mirrors.add(mirror_8);
        		mirror_9 = new Mirror();
        		mirror_9.position.set( -70, 20, 0 );
        		mirrors.add(mirror_9);
        		mirror_10 = new Mirror();
        		mirror_10.position.set( -80, -10, 0 );
        		mirrors.add(mirror_10);
        		mirror_11 = new Mirror();
        		mirror_11.position.set( -50, -20, 0 );
        		mirrors.add(mirror_11);
        		mirror_12 = new Mirror();
        		mirror_12.position.set( -40, -40, 0 );
        		mirrors.add(mirror_12);
        		
        		colour_changer_1 = new Colour_Changer();
                colour_changer_1.position.set( -20, -20, 0 );
        		...
        		mirror_shape[9] = double_refraction;
        		mirror_shape[10] = double_refraction;
        		mirror_shape[11] = double_refraction;
        		mirror_shape[12] = double_refraction;
                ...
                radiation_tiles_colour[13] = geel;
                radiation_tiles_colour[14] = geel;
                radiation_tiles_colour[15] = geel;
        	    ...
        	    rotate_mirrors[9] = 180;
        	    rotate_mirrors[10] = 90;
        	    rotate_mirrors[11] = 270;
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector( 40, 0, 0 ));
        		
        		mirrors.get(1).position.set( new Vector( 70, -20, 0 ));
        		mirrors.get(2).position.set( new Vector( 50, -20, 0 ));
        		mirrors.get(3).position.set( new Vector( 0, 30, 0 ));
        		mirrors.get(4).position.set( new Vector( -30, -20, 0 ));
        		mirrors.get(5).position.set( new Vector( 10, 20, 0 ));
        		mirrors.get(6).position.set( new Vector( -10, 20, 0 ));
        		mirrors.get(7).position.set( new Vector( 10, -30, 0 ));
        		mirrors.get(8).position.set( new Vector( -10, -10, 0 ));
        		mirrors.get(9).position.set( new Vector( -70, 20, 0 ));
        		mirrors.get(10).position.set( new Vector( -80, -10, 0 ));
        		mirrors.get(11).position.set( new Vector( -50, -20, 0 ));
        		mirrors.get(12).position.set( new Vector( -40, -40, 0 ));
        		
        		colour_changers.get(1).position.set( new Vector( -20, -20, 0 ));
