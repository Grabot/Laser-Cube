...
public class Level34 implements Screen
{
	...
	public Level34( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_34_Game", 2 );
			if( prefs.getInteger("Level_35_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_35_Game", 1 );
			}
			if( prefs.getInteger("Level_33_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_33_Game", 1 );
			}
			if( prefs.getInteger("Level_29_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_29_Game", 1 );
			}
			if( prefs.getInteger("Level_39_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_39_Game", 1 );
			}
			prefs.flush();
		}
	}
