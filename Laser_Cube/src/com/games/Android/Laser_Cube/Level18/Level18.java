...
public class Level18 implements Screen
{
	...
	public Level18( Application app, Init_Renderer init, Main main )
	{
		this.init = init;
	...
	public void Game_Finished( int level )
	{
		...
		{
			prefs.putInteger("Level_18_Game", 2 );
			if( prefs.getInteger("Level_17_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_17_Game", 1 );
			}
			if( prefs.getInteger("Level_13_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_13_Game", 1 );
			}
			if( prefs.getInteger("Level_19_Game", 0) == 2)
			{
				
			}
			else
			{
				prefs.putInteger("Level_19_Game", 1 );
			}
			prefs.flush();
		}
	}
