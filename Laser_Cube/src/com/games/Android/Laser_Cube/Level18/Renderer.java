...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(9), radiation_tile_touch[9], red );
        init.Build_Radiation_Tile( gl, simulation.radiation_tiles.get(10), radiation_tile_touch[10], red );
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(1), rotate_mirrors[1], true, single_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(2), rotate_mirrors[2], true, single_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(3), rotate_mirrors[3], true, single_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(4), rotate_mirrors[4], true, single_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(5), rotate_mirrors[5], true, single_refraction );
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(15), rotate_mirrors[15], false, single_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(16), rotate_mirrors[16], false, single_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(17), rotate_mirrors[17], false, single_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(18), rotate_mirrors[18], false, double_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(19), rotate_mirrors[19], false, double_refraction );
