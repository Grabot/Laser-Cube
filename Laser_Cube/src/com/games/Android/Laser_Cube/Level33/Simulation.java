package com.games.Android.Laser_Cube.Level33;
...
{   
        ...
        public Simulation( Level33 level, Main main )
        {
        ...
        public void populate( )
        {
        		...
        		//yellow
        		radiation_tile_1 = new Radiation_Tile( new Vector( 40, 10, 0));
        		radiation_tiles.add( radiation_tile_1 );
        		radiation_tile_2 = new Radiation_Tile( new Vector( 0, 40, 0));
        		...
        		//red
        		radiation_tile_4 = new Radiation_Tile( new Vector( 40, -10, 0));
        		...
        		mirror_12.position.set( 0, -20, 0 );
        		mirrors.add(mirror_12);
        		
        		block_1 = new Block( new Vector( -40, 20, 0 ));
        		blocks.add( block_1 );
        		block_2 = new Block( new Vector( 0, 10, 0 ));
        		blocks.add( block_2 );
        		block_3 = new Block( new Vector( 40, 20, 0 ));
        		blocks.add( block_3 );
        		...
        		blocks.add( block_6 );
        		block_7 = new Block( new Vector( -40, -20, 0 ));
        		blocks.add( block_7 );
        		block_8 = new Block( new Vector( 0, -10, 0 ));
        		blocks.add( block_8 );
        		block_9 = new Block( new Vector( 40, -20, 0 ));
        		blocks.add( block_9 );
