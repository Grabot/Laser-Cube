...
public class Renderer
{
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Mirror( gl, simulation.mirrors.get(11), rotate_mirrors[11], true, double_refraction );
        init.Build_Mirror( gl, simulation.mirrors.get(12), rotate_mirrors[12], true, double_refraction );
