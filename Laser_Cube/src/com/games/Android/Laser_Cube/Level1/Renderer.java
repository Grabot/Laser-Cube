...
public class Renderer
{
	...
	{
		this.init = init;
        Gdx.app.log( Renderer.LOG, "Level 1" );
	...
	public void DrawImages( GL10 gl, Simulation simulation )
	{
        ...
        init.Build_Radiation_Tile( gl, simulation.radiation_tile_1, radiation_tile_touch[1], green );
        ...
        if( help )
        {
        	init.Help_Screen( gl, 1 );
        }
        
        if( game_won )
        {
        	init.Bind_Cleared_Levels();
        	init.game_won_screen( gl, 1 );
        }
