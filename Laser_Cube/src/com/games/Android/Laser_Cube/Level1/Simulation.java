package com.games.Android.Laser_Cube.Level1;
...
{   
        ...
        private float touch_help_level_1_distance = 100;
        ...
        public Simulation( Level1 level, Main main, boolean help )
        {
        		this.help = help;
        		this.level = level;
        		this.main = main;
        ...
        public void populate( )
        {
        		...
        		cube_green = new Cube();
        		cube_green.position.set( 10, -20, 0 );
        		cubes.add(cube_green);
        		
        		radiation_tile_1 = new Radiation_Tile( new Vector( 0, 20, 0));
        ...
        private void Pause_Actions()
        {
        	...
        	if( reset )
        	{
        		cubes.get(1).position.set( new Vector ( 10, -20, 0 ));
        	}
        }
